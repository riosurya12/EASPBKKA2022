...
<html>
<head>
	<title>Dashboard - SewaGedungnya</title>
	...
	<nav class="navbar navbar-default">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo base_url().'admin'; ?>">SewaGedungnya</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li><a href="<?php echo base_url().'admin/kamar'; ?>"><span class="glyphicon glyphicon-bed"></span> Data Gedung</a></li>
					<li><a href="<?php echo base_url().'admin/pelanggan'; ?>"><span class="glyphicon glyphicon-user"></span> Data Pengguna Gedung</a></li>
					<li><a href="<?php echo base_url().'admin/penyewaan'; ?>"><span class="glyphicon glyphicon-credit-card"></span> Transaksi Persewaan Gedung</a></li>
